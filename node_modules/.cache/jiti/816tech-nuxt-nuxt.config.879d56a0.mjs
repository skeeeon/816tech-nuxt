...
var _grayMatter = _interopRequireDefault(await jitiImport("gray-matter"));
var _config = await jitiImport("nuxt/config");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}var _default = exports.default =
  ...
  hooks: {
    'nitro:config'(nitroConfig) {
      if (nitroConfig.prender && nitroConfig.prender.routes) {
        ...
        const files = (0, _nodeFs.readdirSync)(postsDir);

        const seenSlugs = new Set();
        const blogRoutes = files.map((file) => {
          const content = (0, _nodeFs.readFileSync)(_nodePath.default.join(postsDir, file), 'utf-8');
          const { data } = (0, _grayMatter.default)(content);
